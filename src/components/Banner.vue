        ...
        <div class="max-w-[1440px] w-full min-h-[200px] lg:py-[76px] py-[84px] mx-auto relative overflow-hidden">
            <div class="lg:max-w-[917px] sm:max-w-[573px] max-w-[327px] w-full px-[15px] mx-auto">
                <div class="flex sm:flex-row flex-col items-center justify-between">
                    ...
                    <a class="text-[18px] leading-[28px] font-semibold px-[32px] pt-[8px] pb-[11px] border-2 border-[#012F34] rounded-[24px] hover:bg-[#002529] hover:text-white duration-200 ease-out"
                        href="#">contact us</a>
                </div>
            </div>
            <img class="absolute lg:bottom-[-100px] bottom-[-122px] left-0" src="../assets/img/circle-5.svg"
                alt="circle" />
        </div>
    </section>
</template>
